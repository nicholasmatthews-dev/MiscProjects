 ...
 * Description: creating a simple bar chart with a title, values, and labels
 */
...
public class BarChart extends JPanel {
    ...
    private static final String COLOR_PALETTE     = "gray.palette";
    ...
    public void paintComponent(Graphics g) {
        ...
        // if no values were created, there's nothing to do
        ...
        // barWidth is computed based on the width of the panel and the 
    ...
    public static void main(String[] argv) {
        ...
        double[] values = { 15, 40, 20, 25 };

        f.getContentPane().add(new BarChart("Sample Chart", labels, values));
